...
Network* Network::StartHost( int Port )
{
	ActiveConnection = new Network( Port );
	return ActiveConnection;
}

Network* Network::StartClient( std::string Server, int Port )
{
	ActiveConnection = new Network( Server, Port );
	return ActiveConnection;
}
